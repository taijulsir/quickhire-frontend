...
export default function Footer() {
  return (
    <footer className="bg-[#18191B] text-white w-full">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-12 lg:px-20 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4 bg-white/10 p-2 rounded-lg w-max">
